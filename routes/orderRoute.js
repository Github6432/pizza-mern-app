...
const stripe = require('stripe')('sk_test_51PdVHyRuxuekSv8ZVOlGEAegUnZ5KsKYKATS1jjHm2lq3ZuTdO1k0emcTZzblsgrGz3wDveYe1syH7NnOeXLOjsd00NXem5Vel');
...
router.get("/alluserorder", async (req, res) => {
    try {
        ...
        res.status(400).json({ message: "Something Went Wront", error: error.stack, });
    }
});
